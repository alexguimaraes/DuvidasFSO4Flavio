...
public class GUIVaguear extends JFrame {
	...
	public void run() {
		while (!v.flag){
			v.run();
//			System.out.println(textArea + "," + textArea_1 + "," + v.getStringRx() + ", " + v.getStringTx());
			textArea.setText(v.getStringRx());
			textArea_1.setText(v.getStringTx());
		}
	}
	...
	public static void main(String[] args) throws InterruptedException {
		GUIVaguear frame = new GUIVaguear();
		frame.run();
	}
